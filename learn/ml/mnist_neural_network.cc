// This is essentially a C++ implementation of Zhenye's blog post on
...
int main(int argc, char** argv) {
  ...
  //  std::array<float, 28 * 28> X;
  //  // std::array<float, 10> Y;
  //
  //  // |X| x C weight matrix.
  //  std::array<std::array<float, 10>, 28 * 28> W;
  //  // 1 x C bias vector.
  //  std::array<float, 10> B;
  //
  //  auto logits = ElementwiseAddition(MatrixVectorMultiply(W, X), B);
